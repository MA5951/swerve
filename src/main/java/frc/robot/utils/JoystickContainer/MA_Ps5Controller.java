package frc.robot.utils.JoystickContainer;
...
public class MA_Ps5Controller {
    ...
    public void psVibrations(int VibrationAmount,
                             double VibrationStrenght,
                             int VibrationGapMillis,
                             boolean IsRightVibration) {
        new Thread(
            ()-> {
                try{
